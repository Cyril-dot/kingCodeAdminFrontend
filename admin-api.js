...
const API_BASE          = 'https://kingcodebackendgames.onrender.com/api/v1';
const ADMIN_API         = 'https://kingcodebackendgames.onrender.com/api/v1/admin';
const CORRECT_SCORE_API = 'https://kingcodebackendgames.onrender.com/api/admin/correct-score';
